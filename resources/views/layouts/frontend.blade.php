				...
				<div class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<div class="input-group d-none d-lg-flex mx-4">
							<input id="searchInputHome" class="form-control rounded-end pe-5" type="text" name="key" placeholder="Tìm kiếm" />
							...
							<ul class="navbar-nav">
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu">
											<li><a class="dropdown-item" href="{{ route('frontend.sanpham') }}">- Tất cả sản phẩm -</a></li>
											@foreach ($menu_loaisanpham as $value)
												<li><a class="dropdown-item" href="{{ route('frontend.sanpham.phanloai', ['tenloai_slug' => $value->tenloai_slug]) }}">{{ $value->tenloai }}</a></li>
											@endforeach
									</ul>
								...
								<li class="nav-item dropdown">
									...
									<ul class="dropdown-menu">
											<li><a class="dropdown-item" href="{{ route('frontend.baiviet') }}">- Tất cả -</a></li>
											@foreach ($menu_chude as $value)
												<li><a class="dropdown-item" href="{{ route('frontend.baiviet.chude', ['tenchude_slug' => $value->tenchude_slug]) }}">{{ $value->tenchude }}</a></li>
											@endforeach
									</ul>
