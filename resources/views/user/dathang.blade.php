...
<form id="checkout-form" method="post" action="{{ route('user.dathang') }}">
@csrf
<div class="mb-3">
...
<div class="w-50 ps-2">
<a class="btn btn-primary d-block w-100" href="#checkout" onclick="event.preventDefault();document.getElementById('checkout-form').submit();">
<span class="d-none d-sm-inline">Hoàn tất thanh toán</span>
